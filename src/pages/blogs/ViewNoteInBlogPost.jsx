...
const ViewNoteInBlogPost = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.error("Error fetching blogposts/notes:", err);
        }
        };
    ...
    const handleEdit = (noteId) => {
        navigate(`/edit-note/blog-post/${noteId}`);
    };
  ...
  return (
    <div>
      ...
      <h4>Notes for BlogPost: <strong>{title}</strong></h4>
      {notes.length === 0 ? (
        <p>No notes found.</p>
      ) : (
...
export default ViewNoteInBlogPost