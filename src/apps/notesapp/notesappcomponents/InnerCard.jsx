...
function InnerCard({blocks, idx, onDelete, onEdit}) {
  return (  
    <div className="mx-2 mb-3">
      <div className="card">
        <div className="ms-auto z-2">
          ...
          <button className="btn btn-sm btn-outline-success d-flex align-items-center mt-2 me-3">
            <span className="pe-1" onClick={() => onEdit(idx)}>Edit</span>
            <i className="bi bi-trash3 fs-6"></i>
          </button>
        </div>
        ...
        <div className="card-body">
          ...
          <a type="button"  data-bs-toggle="modal" data-bs-target={"#note" + idx}></a>
        </div>
      </div>
